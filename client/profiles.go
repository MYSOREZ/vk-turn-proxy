...
// profiles содержит реалистичные строки user-agent для различных браузеров и платформ.
// Добавляйте или удаляйте профили по необходимости.
...
// getRandomProfile возвращает случайный профиль user-agent.
